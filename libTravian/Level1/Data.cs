...
namespace libTravian
{
    ...
    public class Buildings
    {
        ...
        static private void InitBuildingCost()
        {
            ...
            BuildingCost[27] = new rinfo_array(20, 1.26, new TResAmount(2880, 2740, 2580, 990));
            ...
            BuildingCost[35] = new rinfo_array(10, 1.40, new TResAmount(1460, 930, 1250, 1740));
        ...
        static private void InitDepend()
        {
            ...
            Depends.Add(12, new TBL[] { new TBL(15, 3), new TBL(22, 3) });
            Depends.Add(13, new TBL[] { new TBL(15, 3), new TBL(22, 1) });
