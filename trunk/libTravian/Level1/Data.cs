...
namespace libTravian
{
	...
	public class Buildings
	{
		...
		static private void InitBuildingCost()
		{
			...
			BuildingCost[41] = new rinfo_array(20, 1.28, new TResAmount(780, 420, 660, 540));
		}
		...
		static private void InitUpCost()
		{
			...
			UpCost[1][0] = new TResAmount(940, 800, 1460, 440);
			UpCost[1][11] = new TResAmount(6860, 5840, 10660, 3210);
			UpCost[1][1] = new TResAmount(1635, 1395, 2540, 765);
			UpCost[1][12] = new TResAmount(7315, 6225, 11365, 3425);
			UpCost[1][2] = new TResAmount(2265, 1925, 3515, 1060);
			UpCost[1][13] = new TResAmount(7765, 6605, 12055, 3635);
			UpCost[1][3] = new TResAmount(2850, 2425, 4425, 1335);
			UpCost[1][14] = new TResAmount(8205, 6980, 12740, 3840);
			UpCost[1][4] = new TResAmount(3405, 2900, 5290, 1595);
			UpCost[1][15] = new TResAmount(8640, 7350, 13415, 4045);
			UpCost[1][5] = new TResAmount(3940, 3355, 6120, 1845);
			UpCost[1][16] = new TResAmount(9065, 7715, 14085, 4245);
			UpCost[1][6] = new TResAmount(4460, 3795, 6925, 2085);
			UpCost[1][17] = new TResAmount(9490, 8080, 14740, 4445);
			UpCost[1][7] = new TResAmount(4960, 4220, 7705, 2320);
			UpCost[1][18] = new TResAmount(9910, 8435, 15395, 4640);
			UpCost[1][8] = new TResAmount(5450, 4640, 8465, 2550);
			UpCost[1][19] = new TResAmount(10325, 8790, 16040, 4835);
			UpCost[1][9] = new TResAmount(5930, 5050, 9210, 2775);
			UpCost[1][20] = new TResAmount(10740, 9140, 16675, 5025);
			UpCost[1][10] = new TResAmount(6400, 5450, 9940, 2995);
